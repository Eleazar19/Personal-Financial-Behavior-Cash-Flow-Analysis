...
Next, key financial metrics such as net cash flow, spending timing, and monthly expense trends were derived. Pivot tables and time-based analysis were applied to evaluate month-to-month changes, spending concentration periods, and saving capacity across the year.
